...
export default function App() {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // No need to do anything here as filtering is handled by useEffect
  };
        ...
        <div className="container">
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p> I am a storyteller and poet who crafts immersive worlds through words. Beyond prose, I create captivating front-end websites, merging creativity with code. My YouTube channel offers insights into my creative process, writing snippets, and web development projects. Join me on a journey where imagination meets technology, and creativity knows no bounds. </p>
            </div>
          </div>
        </div>
      </section>
